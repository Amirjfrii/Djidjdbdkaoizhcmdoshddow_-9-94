...
import os
#================= Config =================#
owner = 1495973057 # Owner ID
api_id = 9266589 # API ID
api_hash = "f78f09d45be03b07a498636ebb774d08" # API HASH
bot_token = "7729006326:AAEP-qF0ZQW2t1Nm17tUMJITfXry3YNrd7w" # Bot Token
DBName = "helper" # Database Name
DBUser = "helper" # Database User
DBPass = "helper" # Database Password
#==========================================#
